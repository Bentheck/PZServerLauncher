...
public sealed class SettingsCatalogResolverTests
{
    ...
    public void Resolve_ReturnsBranchSpecificCatalogMetadata()
    {
        ...
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.server.respawn-with-self" && field.Target.KeyPath == "PlayerRespawnWithSelf");
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.server.respawn-with-other" && field.Target.KeyPath == "PlayerRespawnWithOther");
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.server.world-item-removal-hours" && field.Target.KeyPath == "HoursForWorldItemRemoval");
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.server.world-item-removal-list" && field.Target.KeyPath == "WorldItemRemovalList");
        ...
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.network.mouse-over-display-name" && field.Target.KeyPath == "MouseOverToSeeDisplayName");
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.network.hide-players-behind-you" && field.Target.KeyPath == "HidePlayersBehindYou");
        Assert.Contains(stable.Pages.SelectMany(page => page.Sections).SelectMany(section => section.Fields), field => field.FieldId == "b41.network.player-bump-player" && field.Target.KeyPath == "PlayerBumpPlayer");
